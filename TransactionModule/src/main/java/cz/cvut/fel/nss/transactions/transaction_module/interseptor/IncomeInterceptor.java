package cz.cvut.fel.nss.transactions.transaction_module.interseptor;
...
/**
 * Intercepts requests related to income and logs information during the handling of these requests.
 */
@Component
